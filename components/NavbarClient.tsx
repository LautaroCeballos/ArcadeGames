        ...
        <div className="hidden items-center gap-2.5 sm:flex flex-1 justify-end">
          ...
          {user ? (
            <>
              <Link
                href="/subir"
                className="relative inline-flex items-center gap-1.5 rounded-lg bg-primary px-4 py-1.5 text-sm font-semibold text-white shadow-lg transition-all hover:brightness-110 hover:shadow-xl"
                style={{
              ...
              >
                ...
                <span className="relative">Publicar Proyecto</span>
              </Link>
